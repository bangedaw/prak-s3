...
treeFoldPost f x Empty = x
treeFoldPost f x (Node a l r) = f (treeFoldPost f x l) (treeFoldPost f x r) a
-- SPESIFIKASI
...
treeFoldPre f x Empty = x 
treeFoldPre f x (Node a l r) = f a (treeFoldPre f x l) (treeFoldPre f x r)
...
treeFoldIn f x Empty = x 
treeFoldIn f x (Node a l r) = f (treeFoldIn f x l) a (treeFoldIn f x r)
